...
public:
    ...
    Wrapper_1(const char * name){
      time = 0;
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess(&(top.io_regio_raddr1));
      signalAccess[1] = new CDataSignalAccess(&(top.io_regio_raddr2));
      signalAccess[2] = new CDataSignalAccess(&(top.io_regio_waddr));
      signalAccess[3] = new QDataSignalAccess(&(top.io_regio_wdata));
      signalAccess[4] = new CDataSignalAccess(&(top.io_regio_wen));
      signalAccess[5] = new QDataSignalAccess(&(top.io_regio_rdata1));
      signalAccess[6] = new QDataSignalAccess(&(top.io_regio_rdata2));
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\Work\\Code\\ChiselPrj\\.\\simWorkspace\\RegFile/") + name + ".vcd").c_str());
      #endif
    }
